...
import sourced.ml.core as core
from sourced.ml.core.models import BOW

from sourced.ml.mining.cmd.bow_converters import bow2vw
...
class Bow2vwTests(unittest.TestCase):
    ...
    def test_repo2bow(self):
        ...
        backup = core.models.BOW.convert_bow_to_vw
        core.models.BOW.convert_bow_to_vw = fake_convert_bow_to_vw
        try:
            bow2vw(args)
        finally:
            core.models.BOW.convert_bow_to_vw = backup
