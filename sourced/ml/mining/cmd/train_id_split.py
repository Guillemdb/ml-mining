...
def train_id_split(args: argparse.ArgumentParser):
    ...
    from sourced.ml.core.algorithms.id_splitter.nn_model import build_rnn, build_cnn,\
        prepare_devices
    from sourced.ml.core.algorithms.id_splitter.pipeline import make_lr_scheduler, \
        set_random_seed, prepare_callbacks, build_train_generator, create_generator_params, \
        str2ints, config_keras, report
